...
(() => {
  ...
  const videos = [
    ...
    ['pwmK2LKeEAI','2025-05-03T10:46:00','YAMANOGUCHIさんのZ1の迫力あるエンジンサウンド','RYUSEIのZRX400を修理してくれているYAMANOGUCHIさんのKawasaki Z1フォア。RYUSEIと修理の具合を見に訪れた日に、最近購入された一台の迫力あるサウンドを残した動画。'],
